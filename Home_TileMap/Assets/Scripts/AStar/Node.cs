...
public class Node : IComparable<Node>
{
    ...
    /// <summary>
    /// 순서 비교용으로 IComparable를 상속받을 경우 구현해야하는 함수
    /// </summary>
    ...
    public override bool Equals(object obj)
    {
        ...
        // obj가 Node인지 아닌지 확인하고 Node가 맞으면 other 이름으로 바꿔준다.
    }

    public override int GetHashCode()   // 서로 다른 데이터를 넣으면 항상 서로 다른 값이 나오게 해주는 함수
    {
        return HashCode.Combine(x, y);
    }

    /// <summary>
    /// == 명령어 오버로딩(==와 !=은 반드시 쌍으로 구현해야 한다) // 연산자 오버로딩
    /// </summary>
